...
class Googlemaps {
	...
	var $center						= "4.10915, -76.1888";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
